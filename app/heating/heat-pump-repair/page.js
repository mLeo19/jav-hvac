...
const HeatPumpRepair = () => {
  ...
  let heading = 'Florida\'s Most Trusted Heat Pump Repairments'
  ...
  return (
    <div>
      <Hero bg='/water-heater-system.jpg' heading='Heat Pump Repair' subheading='Hire HVAC Experts That Can Meet All Your Air Conditioning Needs'/>
