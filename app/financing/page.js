...
const Financing = () => {
  ...
  let heading = 'Affordability With PACE'
  let title = 'Leverage the Value of your Home for Any Solution'
  ...
  return (
    <div>
      <Hero bg='/financing.jpg' heading='Financing With PACE' subheading='To Meet Any Kind of Solution, No Matter the Economics'  />
