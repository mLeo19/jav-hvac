...
const UvLight = () => {
  ...
  let heading = 'Florida\'s Top Tier UV Light Solutions for Air Quality'
  ...
  return (
    <div>
      <Hero bg='/uv-light.jpg' heading='UV Light Solutions' subheading='Hire HVAC Experts That Can Meet All Your Air Conditioning Needs'/>
