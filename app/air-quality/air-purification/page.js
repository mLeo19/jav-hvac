...
const AirPurification = () => {
  ...
  let heading = 'Florida\'s Top Tier Solutions for Air Purification'
  ...
  return (
    <div>
      <Hero bg='/air-purification.jpg' heading='Air Purification Solutions' subheading='Hire HVAC Experts That Can Meet All Your Air Conditioning Needs'/>
