...
const About = () => {
  ...
  return (
    <div>
      <Hero bg='/bg-image.jpg' heading='About JAV Cooling' subheading='Get to know the team that will serve your HVAC needs moving forward!' />
