...
const SmartThermostats = () => {
  ...
  let heading = 'Florida\'s Most Reliable Solutions for Smart Thermostats'
  ...
  return (
    <div>
      <Hero bg='/smart-thermostats.jpg' heading='Smart Thermostats' subheading='Hire HVAC Experts That Can Meet All Your Air Conditioning Needs'/>
