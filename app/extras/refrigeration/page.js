...
const Refrigeration = () => {
  ...
  let heading = 'Florida\'s Most Reliable Solutions for Refrigeration'
  ...
  return (
    <div>
      <Hero bg='/refrigeration.jpg' heading='Refrigeration' subheading='Hire HVAC Experts That Can Meet All Your Air Conditioning Needs'/>
