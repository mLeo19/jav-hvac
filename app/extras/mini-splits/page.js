...
const MiniSplits = () => {
  ...
  let heading = 'Florida\'s Most Reliable Solutions for Mini Splits'
  let title = 'Keeping Our Clients\' Air Pure All Year Long'
  ...
  return (
    <div>
      <Hero bg='/mini-splits.jpg' heading='Mini-Splits' subheading='Hire HVAC Experts That Can Meet All Your Air Conditioning Needs'/>
