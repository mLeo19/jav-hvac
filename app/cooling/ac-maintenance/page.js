...
const AcMaintenance = () => {
  ...
  let heading = 'Florida\'s Highest Rated AC Maintenance'
  ...
  return (
    <div>
      <Hero bg='/air-conditioner-system.jpg' heading='AC Maintenance' subheading='Hire HVAC Experts That Can Meet All Your Air Conditioning Needs'/>
