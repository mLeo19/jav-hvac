...
const AcRepair = () => {
  ...
  let heading = 'Florida\'s Most Reliable AC Repairments'
  let title = 'Efficiently fixing AC issues for clients in West Palm Beach and Beyond'
  ...
  return (
    <div>
      <Hero bg='/air-conditioner-system.jpg' heading='AC Repairments' subheading='Hire HVAC Experts That Can Meet All Your Air Conditioning Needs'/>
