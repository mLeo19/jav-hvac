...
const AcInstallation = () => {
  ...
  let heading = 'Florida\'s Most Trusted AC Installations'
  let title = 'Keeping Our Clients Cool in West Palm Beach and Beyond'
  ...
  return (
    <div>
      <Hero bg='/air-conditioner-system.jpg' heading='AC Intallations' subheading='Hire HVAC Experts That Can Meet All Your Air Conditioning Needs'/>
