  ...
  return (
    ...
    >
      ...
      <div className="relative h-32">
        <div className="  absolute top-0 left-1/2 -translate-x-1/2 w-32  h-24 pointer-events-none before:absolute  before:rounded-full before:-z-10">
          <div className="  h-full [mask-image:_linear-gradient(0deg,transparent,theme(colors.white)_20%,theme(colors.white))]">
            ...
            {testimonials.map((testimonial, index) => (
              ...
              >
                <Image className="relative top-11 left-1/2  rounded-full " src={testimonial.img} fill alt={testimonial.name} />
              </Transition>
            ))}
