...
import { Disclosure, Menu, Transition, DisclosureButton, DisclosurePanel, CloseButton } from '@headlessui/react'
            ...
            <div className="relative flex py-3 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center lg:items-stretch lg:justify-between ">    
                <CloseButton 
                  as={MyLink}
                  href='/'
                  className="flex flex-shrink-0 items-center transition-all ease-in-out "
                >
                  <Image
                  ...
                  {item.submenu ? (
                    <>
                      <Disclosure>
                        {({ open }) => (
                          <>
                            <DisclosureButton className="flex w-full justify-between px-4 py-2 text-left text-base font-medium">
                              <span>{item.name}</span>
                              <ChevronUpIcon
                                className={`${
                            ...
                            <DisclosurePanel className="border-t-2 border-gray-600 dark:border-gray-300 px-4 py-1 text-sm">
