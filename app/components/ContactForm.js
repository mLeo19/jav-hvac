        ...
        <div className="my-8 lg:my-14 px-8 mx-auto max-w-screen-md sm:px-6 lg:max-w-7xl lg:px-8">
          ...
          <form action="#" className="space-y-8">
            <div>
              ...
              <input type="email" id="email" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5" placeholder="name@javcontractors.com" required />
            </div>
            <div>
            ...
            <div className="sm:col-span-2">
              ...
              <textarea id="description" rows="6" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500" placeholder="Tell us about your project..."></textarea>
            </div>
            <button onClick={handleClick} type="submit" className="bg-transparent hover:bg-blue-500 text-black hover:text-white font-semibold py-2 px-4 border border-black rounded-md shadow-md transition ease-in-out">Send message</button>
          </form>
          </div>
        </div>
      </section>
